    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Button b = findViewById(R.id.btn_getallpri);
                Button c = findViewById(R.id.btn_getlog);
                ActionBar actionBar = getActionBar();
                if (actionBar != null) {
...
//			 dest.writeInt(versionCode);
    ...
    /**
     * 获取所有应用，并按照权限分类
     * @param getSysPackages：是否获取系统应用权限
     * @return ArrayList<PInfo> 应用权限列表
     */
    ...
    public void onClick(View arg0) {
        if (arg0.getId() == R.id.btn_getallpri) {
...
//                finish();
        ...
        } else if (arg0.getId() == R.id.btn_getlog) {
            try {
...
//                finish();
        ...
        } else if (arg0.getId() == R.id.btn_about) {
            try {
                new AlertDialog.Builder(this)
                        .setMessage("本项目为2022年系统软件设计大作业 \n\n"
                        + "用于实现对于应用权限的监控及管理 \n\n"
                        + "  【开发人员】\n\n   白玮琦 季嘉舟 易红旭" )
                        .setTitle("关于EUNOMIA")
